...
document.addEventListener("DOMContentLoaded", function () {
  ...
  <div href="${product.link}"  class="p-2 m-0  rounded-5  text-center"
            style="background:transparent; box-shadow: 0 15px 30px rgba(0,0,0,0.1); color:var(--bs-primary); bordeґr:3px solid var(--bs-primary);">
               ...
               <button type="button" class="m-0 p-0 btn btn-transparent border-0 portfolio-details" data-bs-toggle="modal"
    data-bs-target="${product.link}">
...
//   scroll-top
  ...
  window.addEventListener('scroll', () => {
    if (window.scrollY > 200) { // коли прокрутка більше 200px
